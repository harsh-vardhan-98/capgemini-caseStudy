...
public class PatymController {
	...
	public ModelAndView getRedirect(@RequestParam(name = "CUST_ID") String customerId,
		...
		System.out.println("in Pg direct");
	...
	public String getResponseRedirect(HttpServletRequest request, Model model) {
		...
		payModel.setOrderId(parameters.get("ORDERID"));
		payModel.setCust_id(parameters.get("CUST_ID"));
		payModel.setAmount(parameters.get("TXNAMOUNT"));
		payModel.setStatus(parameters.get("STATUS"));
		payModel.setDate(parameters.get("TXNDATE"));
		
		paymentRepository.save(payModel);
		System.out.println(parameters.get("ORDERID"));
		System.out.println(parameters.get("CUST_ID"));
