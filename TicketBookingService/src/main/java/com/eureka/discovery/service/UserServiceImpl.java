...
import com.eureka.discovery.model.DatabaseSequence;
...
public class UserServiceImpl implements UserService {
	...
	public void sendEmail(long pnrNo) throws AddressException {
		...
		final Email email = DefaultEmail.builder().from(new InternetAddress("harshkaurav37@gail.com"))
				.replyTo(new InternetAddress(userDet.getEmail()))
				.to(Lists.newArrayList(new InternetAddress(userDet.getEmail())))
	...
	public void sendEmails(long pnrNo) throws AddressException {
		UserDetails userDet = getUserDetailsById(pnrNo);
		final Email email = DefaultEmail.builder().from(new InternetAddress("harshkaurav37@gmail.com"))
				.replyTo(new InternetAddress(userDet.getEmail()))
				.to(Lists.newArrayList(new InternetAddress(userDet.getEmail())))
