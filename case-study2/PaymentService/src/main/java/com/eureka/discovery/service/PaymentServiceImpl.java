...
import com.eureka.discovery.repository.UserPaymentRepository;
...
public class PaymentServiceImpl implements PaymentService {
	...
	public void sendEmail(PaymentDetails payment) throws AddressException {
		final Email email = DefaultEmail.builder().from(new InternetAddress("harshkaurav37@gmail.com"))
				.replyTo(new InternetAddress("harshkaurav37@gmail.com"))
				.to(Lists.newArrayList(new InternetAddress("harshkaurav37@gmail.com")))
