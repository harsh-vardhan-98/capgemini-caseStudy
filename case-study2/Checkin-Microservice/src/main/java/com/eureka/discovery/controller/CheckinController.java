...
import com.eureka.discovery.service.CheckinService;
...
public class CheckinController {
	...
	public CheckinDetails addCheckinDetails(@PathVariable long pnrNo) {
		...
		UserDetails user = restTemplate.getForObject("http://localhost:8080/book/get/" + pnrNo, UserDetails.class);
		...
		TrainDetails trainDetails = restTemplate.getForObject("http://localhost:8080/admin/access/find/" + trainNo,
				TrainDetails.class);
